...
class BaseOptions:
    ...
    def initialize(self):
        ...
        # networks
        self.parser.add_argument('--net-name', type=str, default='ENDE_GNN', 
        ...
        self.parser.add_argument('--dec-hidden-size', type=int, default=512)
        self.parser.add_argument('--dropout', type=float, default=0)
        self.parser.add_argument('--hidden-dim', type=int, default=512)
        self.parser.add_argument('--r-weight', type=float, default=0.1)
